...
import 'package:seizure_deck/data/comments.dart';
...
class _DiscussionScreenState extends State<DiscussionScreen> {
  ...
  Future<void> fetchComments() async {
    ...
    final response = await http.get(Uri.parse('${globals.dbstart_url}community_get.php'));
  ...
  Future<void> _addMessage(String text) async {
    ...
    final response = await http.post(
        Uri.parse('${globals.dbstart_url}community.php'),
        body:{
          'uid': uid.toString(),
          'comment': text,
